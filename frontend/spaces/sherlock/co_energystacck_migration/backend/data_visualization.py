...
are used by both this module and ``series_data_manager``.
...
def rgb_to_rgba(color, alpha=0.2):
    """
    Convert a Plotly RGB color string or named color to an RGBA string with the given alpha.

    Args:
        color (str): Color in 'rgb(r,g,b)' or named format.
