...
from ..backend.series_data_manager import SeriesDataManager, classify_columns
from ..backend.tag_manager import TAG_SERIES, tag_column
...
def _build_faceted_figure(df, x_col, y1_cols, y2_cols, data_manager,
    ...
    from ..backend.data_visualization import rgb_to_rgba
