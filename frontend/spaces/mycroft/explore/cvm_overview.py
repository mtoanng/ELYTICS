                        ...
                        dmc.Stack(
                            ...
                            children=[
                                dmc.SimpleGrid(
                                    ...
                                    spacing="md",
                                    children=[
                                        dmc.InputWrapper(dcc.Dropdown(id="myc-cvm-stack", multi=True, style={"width": "100%"}), label="Stack Short Number", htmlFor="myc-cvm-stack", className="dmc", styles={"label": {"marginBottom": "6px"}}),
                                        dmc.InputWrapper(dcc.Dropdown(id="myc-cvm-eol", value="cvm_assembly", clearable=False, style={"width": "100%"}), label="EOL Type", htmlFor="myc-cvm-eol", className="dmc", styles={"label": {"marginBottom": "6px"}}),
                                        dmc.InputWrapper(dcc.Dropdown(id="myc-cvm-cells", multi=True, style={"width": "100%"}), label="Number of Cells", htmlFor="myc-cvm-cells", className="dmc", styles={"label": {"marginBottom": "6px"}}),
                                    ],
                                ),
                                dmc.SimpleGrid(
                                    ...
                                    spacing="md",
                                    children=[
                                        dmc.InputWrapper(dcc.Dropdown(id="myc-cvm-state", multi=True, style={"width": "100%"}), label="Location Result State", htmlFor="myc-cvm-state", className="dmc", styles={"label": {"marginBottom": "6px"}}),
                                        dmc.InputWrapper(dcc.Dropdown(id="myc-cvm-attr", multi=True, style={"width": "100%"}), label="Part Attribute", htmlFor="myc-cvm-attr", className="dmc", styles={"label": {"marginBottom": "6px"}}),
                                        dmc.InputWrapper(dcc.Dropdown(id="myc-cvm-measure", multi=True, style={"width": "100%"}), label="CVM Measurement Type", htmlFor="myc-cvm-measure", className="dmc", styles={"label": {"marginBottom": "6px"}}),
                                        dmc.InputWrapper(dcc.Dropdown(id="myc-cvm-outlier", multi=True, style={"width": "100%"}), label="CVM Outlier Detection", htmlFor="myc-cvm-outlier", className="dmc", styles={"label": {"marginBottom": "6px"}}),
                                    ],
                                ),
                            ],
                        ),
