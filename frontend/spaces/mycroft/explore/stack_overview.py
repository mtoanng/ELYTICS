                ...
                dmc.Paper(
                    ...
                    children=[
                        dmc.Group(
                            ...
                            style={"flexWrap": "wrap"},
                            children=[
                                dmc.InputWrapper(dcc.Dropdown(id="myc-stack-id", multi=True, style={"width": "100%"}), label="Stack Short Number", htmlFor="myc-stack-id", className="dmc", styles={"label": {"marginBottom": "6px"}}, style={"flex": "1", "minWidth": "180px"}),
                                dmc.InputWrapper(dcc.Dropdown(id="myc-stack-up", multi=True, style={"width": "100%"}), label="Unique Part ID", htmlFor="myc-stack-up", className="dmc", styles={"label": {"marginBottom": "6px"}}, style={"flex": "1", "minWidth": "180px"}),
                                dmc.InputWrapper(dcc.Dropdown(id="myc-stack-cells", multi=True, style={"width": "100%"}), label="Number of Cells", htmlFor="myc-stack-cells", className="dmc", styles={"label": {"marginBottom": "6px"}}, style={"flex": "1", "minWidth": "180px"}),
                                dmc.InputWrapper(dcc.Dropdown(id="myc-stack-state", multi=True, style={"width": "100%"}), label="Location Result State desc.", htmlFor="myc-stack-state", className="dmc", styles={"label": {"marginBottom": "6px"}}, style={"flex": "1", "minWidth": "220px"}),
                                dmc.InputWrapper(dcc.Dropdown(id="myc-stack-part-attr", multi=True, style={"width": "100%"}), label="Part Attribute desc.", htmlFor="myc-stack-part-attr", className="dmc", styles={"label": {"marginBottom": "6px"}}, style={"flex": "1", "minWidth": "220px"}),
