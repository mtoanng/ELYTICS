                ...
                dmc.Paper(
                    ...
                    children=[
                        dmc.Group(
                            ...
                            style={"flexWrap": "wrap"},
                            children=[
                                dmc.InputWrapper(dcc.Dropdown(id="myc-stack-id", multi=True, style={"width": "100%"}), label="Stack_short_nr", htmlFor="myc-stack-id", className="dmc", styles={"label": {"marginBottom": "6px"}}, style={"flex": "1", "minWidth": "180px"}),
                                dmc.InputWrapper(dcc.Dropdown(id="myc-stack-up", multi=True, style={"width": "100%"}), label="Uniquepart_id", htmlFor="myc-stack-up", className="dmc", styles={"label": {"marginBottom": "6px"}}, style={"flex": "1", "minWidth": "180px"}),
