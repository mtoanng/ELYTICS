...
```text
https://github.com/mtoanng/ELYTICS.git
```
[
    {
        "name": "Azure",
        ...
        "apiType": "responses",
        "apiKey": "${input:chat.lm.secret.-6f316f7a}",
        "models": [
            {
                "id": "gpt-5.3-codex",
                "name": "Cô đéch 5.3",
                "url": "https://xplatform-openai-shared.openai.azure.com/openai",
                "toolCalling": true,
                "vision": true,
    ...
    },
    {
        ...
        "vendor": "customendpoint",
        "apiType": "responses",
        "apiKey": "${input:chat.lm.secret.-47b133e8}",
        "models": [
            {
                "id": "gpt-5.3-codex-s3",
                "name": "Cô đéch 5.3 (S3)",
                "url": "https://xplatform-openai-shared3.openai.azure.com/openai",
                "toolCalling": true,
                "vision": true,
                "maxInputTokens": 320000,
                "maxOutputTokens": 32000
