...
- withKeyboardEvents (boolean; optional):
    ...
    def __init__(
        ...
        autoplay: typing.Optional[typing.Optional[typing.Union[bool, typing.Dict[str, typing.Any]]]] = None,
        autoScroll: typing.Optional[typing.Optional[typing.Union[bool, typing.Dict[str, typing.Any]]]] = None,
