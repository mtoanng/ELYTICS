...
- colors (list of strings; optional):
    Colors array, used to calculate color for each value, by default 4
    shades of green colors are used.

- darkHidden (boolean; optional):
    Determines whether component should be hidden in dark color scheme
    with `display: none`.

- data (dict with strings as keys and values of type number; required):
    Heatmap data, key is date in `YYYY-MM-DD` format (interpreted as a
    UTC calendar day).
...
- domain (list of 2 elements: [number, number]; optional):
    Heatmap domain, array of 2 numbers, min and max values, calculated
    from data by default.

- endDate (string; optional):
    Heatmap end date. Current date by default. Date is normalized to
    UTC midnight of the intended calendar day.

- ff (string | dict; optional):
    Font family – Accepts CSS values or a dict for responsive styles.

- firstDayOfWeek (a value equal to: 0, 2, 1, 3, 4, 5, 6; optional):
...
- getTooltipLabel (boolean | number | string | dict | list; optional):
    A function to generate tooltip label based on the hovered rect
    date and value, required for the tooltip to be visible.
...
- hoverData (dict with strings as keys and values of type number; optional):
...
- monthLabels (list of strings; optional):
    Month labels, array of 12 elements, can be used for localization.

- monthsLabelsHeight (number; optional):
...
- rectRadius (number; optional):
    Rect radius in px. Default 2.

- rectSize (number; optional):
...
- splitMonths (boolean; optional):
    If set, inserts a spacer column between months. Default False.

- startDate (string; optional):
    Heatmap start date. Current date - 1 year by default. Date is
    normalized to UTC midnight of the intended calendar day.
...
- weekdayLabels (list of strings; optional):
    Weekday labels, array of 7 elements, can be used for localization.

- weekdaysLabelsWidth (number; optional):
    Width of weekday labels column. Default 30.

- withMonthLabels (boolean; optional):
    If set, month labels are displayed. Default False.

- withOutsideDates (boolean; optional):
    If set, trailing dates that do not fall into the given `startDate`
    – `endDate` range are displayed to fill empty space. Default True.

- withTooltip (boolean; optional):
    If set, tooltip is displayed on rect hover. Default False.

- withWeekdayLabels (boolean; optional):
    ...
    def __init__(
        self,
        data: typing.Optional[typing.Dict[typing.Union[str, float, int], NumberType]] = None,
        domain: typing.Optional[typing.Tuple[NumberType, NumberType]] = None,
        startDate: typing.Optional[typing.Union[str]] = None,
        endDate: typing.Optional[typing.Union[str]] = None,
        withMonthLabels: typing.Optional[bool] = None,
        monthLabels: typing.Optional[typing.Sequence[str]] = None,
        withWeekdayLabels: typing.Optional[bool] = None,
        weekdayLabels: typing.Optional[typing.Sequence[str]] = None,
        withOutsideDates: typing.Optional[bool] = None,
        firstDayOfWeek: typing.Optional[Literal[0, 2, 1, 3, 4, 5, 6]] = None,
        rectSize: typing.Optional[NumberType] = None,
        gap: typing.Optional[NumberType] = None,
        rectRadius: typing.Optional[NumberType] = None,
        colors: typing.Optional[typing.Sequence[str]] = None,
        weekdaysLabelsWidth: typing.Optional[NumberType] = None,
        monthsLabelsHeight: typing.Optional[NumberType] = None,
        fontSize: typing.Optional[NumberType] = None,
        getTooltipLabel: typing.Optional[typing.Any] = None,
        withTooltip: typing.Optional[bool] = None,
        tooltipProps: typing.Optional[typing.Any] = None,
        splitMonths: typing.Optional[bool] = None,
        clickData: typing.Optional["ClickData"] = None,
        hoverData: typing.Optional[typing.Dict[typing.Union[str, float, int], NumberType]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'aria-*', 'attributes', 'bd', 'bdrs', 'bg', 'bga', 'bgp', 'bgr', 'bgsz', 'bottom', 'c', 'className', 'classNames', 'clickData', 'colors', 'darkHidden', 'data', 'data-*', 'display', 'domain', 'endDate', 'ff', 'firstDayOfWeek', 'flex', 'fontSize', 'fs', 'fw', 'fz', 'gap', 'getTooltipLabel', 'h', 'hiddenFrom', 'hoverData', 'inset', 'left', 'lh', 'lightHidden', 'loading_state', 'lts', 'm', 'mah', 'maw', 'mb', 'me', 'mih', 'miw', 'ml', 'mod', 'monthLabels', 'monthsLabelsHeight', 'mr', 'ms', 'mt', 'mx', 'my', 'opacity', 'p', 'pb', 'pe', 'pl', 'pos', 'pr', 'ps', 'pt', 'px', 'py', 'rectRadius', 'rectSize', 'right', 'splitMonths', 'startDate', 'style', 'styles', 'ta', 'tabIndex', 'td', 'tooltipProps', 'top', 'tt', 'unstyled', 'variant', 'visibleFrom', 'w', 'weekdayLabels', 'weekdaysLabelsWidth', 'withMonthLabels', 'withOutsideDates', 'withTooltip', 'withWeekdayLabels']
